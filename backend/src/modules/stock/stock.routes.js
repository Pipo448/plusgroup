...
// Ajustement manuel
// ⚠️ NOUVO — requireBranchForWrite anpeche ajistman "san branch" lè admin
// an mòd Global (pandan tenant lan gen omwen yon branch)
router.post('/adjust', authorize('admin', 'stock_manager'), extractBranch, requireBranchForWrite, asyncHandler(async (req, res) => {
...
// Réapprovisionnement
router.post('/purchase', authorize('admin', 'stock_manager'), extractBranch, requireBranchForWrite, asyncHandler(async (req, res) => {
