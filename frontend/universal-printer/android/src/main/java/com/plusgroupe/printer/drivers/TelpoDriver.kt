 ...
 */
class TelpoDriver(private val context: Context) : PrinterDriver {
    override fun initialize(): Boolean = false
    override fun isReady(): Boolean = false
    override fun getStatusMessage(): String = "TelpoDriver — POKO IMPLEMENTE"
    override fun print(lines: JSONArray, copies: Int): PrinterDriver.Result {
        return PrinterDriver.Result(false, "TelpoDriver poko fini")
    }
