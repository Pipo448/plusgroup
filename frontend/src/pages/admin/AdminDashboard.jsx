  ...
  return (
    <div style={{ minHeight:'100vh', background:'linear-gradient(160deg, #0a0a0f 0%, #0d1b2a 50%, #0f0a00 100%)', fontFamily:'DM Sans, sans-serif', position:'relative' }}>
      ...
      <main style={{ padding: isMobile?'16px 12px':'28px', maxWidth:1200, margin:'0 auto', position:'relative', zIndex:1, paddingBottom:80 }}>
        ...
        {/* ✅ PLUS INTERNET */}
        <div style={{ background:'rgba(255,255,255,0.02)', border:'1px solid rgba(99,102,241,0.15)', borderRadius:20, overflow:'hidden', backdropFilter:'blur(10px)', boxShadow:'0 8px 40px rgba(0,0,0,0.4)', marginTop:24 }}>
          <div style={{ padding: isMobile?'14px 16px':'18px 24px', borderBottom:'1px solid rgba(99,102,241,0.08)', background:'rgba(99,102,241,0.03)' }}>
            <h3 style={{ margin:0, fontSize: isMobile?14:15, fontWeight:700, color:'#fff', fontFamily:"'Playfair Display'" }}>📡 PLUS INTERNET</h3>
            {!isMobile && <p style={{ margin:0, fontSize:10, color:'rgba(99,102,241,0.6)', letterSpacing:'0.06em' }}>JERE ISP YO AK KLIYAN ENTÈNÈT YO</p>}
          </div>
          <div style={{ padding: isMobile?'14px 16px':'20px 24px' }}>
            <InternetTab adminApi={adminApi} isMobile={isMobile} />
          </div>
        </div>
