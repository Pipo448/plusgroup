...
const EMPTY_FORM = {
  ...
  momentPriceHtg:'', momentPricePerHourHtg:'',
...
export default function RoomTypesPage() {
  ...
  const handleSubmit = () => {
    ...
    const payload = {
      ...
      momentPriceHtg:        form.momentPriceHtg ? Number(form.momentPriceHtg) : null,
      momentPricePerHourHtg: form.momentPricePerHourHtg ? Number(form.momentPricePerHourHtg) : null,
              ...
              <div style={{ padding:'18px 18px 16px' }}>
                <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:10 }}>
                  ...
                  <div style={{ display:'flex', gap:6, flexShrink:0, marginLeft:8 }}>
                    <button onClick={() => openEdit(rt)} style={{ width:30, height:30, borderRadius:8, border:`1px solid ${D.border}`, background:D.blueDim, color:D.blue, cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center' }}>
                      <Pencil size={13}/>
                    </button>
                    <button onClick={() => setDeleteConfirm(rt)} style={{ width:30, height:30, borderRadius:8, border:'1px solid rgba(192,57,43,0.15)', background:D.redDim, color:D.red, cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'center' }}>
                      <Trash2 size={13}/>
                    </button>
                  </div>
                </div>
